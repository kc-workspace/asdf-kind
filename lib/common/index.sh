...
KC_ASDF_NAME="asdf-kind"
KC_ASDF_REPO="https://github.com/kc-workspace/asdf-kind"
export KC_ASDF_ORG KC_ASDF_NAME KC_ASDF_REPO

## Application information
KC_ASDF_APP_TYPE="standalone"
KC_ASDF_APP_NAME="kind"
KC_ASDF_APP_WEBS="https://kind.sigs.k8s.io/"
KC_ASDF_APP_DESC="local clusters for testing Kubernetes"
KC_ASDF_APP_CMDS="
- test    - test if cli exist and executable
- version - print *plugin* version
"
KC_ASDF_APP_REPO="https://github.com/kubernetes-sigs/kind"
